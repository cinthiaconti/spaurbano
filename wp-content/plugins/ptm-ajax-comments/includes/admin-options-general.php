<div id="general" class="optionTab">
	...
	<table class="form-table">
		<tr>
			...
			<td><input type="text" name="callback_name" id="callback_name" value="<?php echo $settings['callback_name'] ?>" class="regular-text code" />&nbsp;<span class="description">wp_list_comments('type=comment&callback=<span class="highlight">fd_comment</span>')</span></td>
		</tr>
	</table>
