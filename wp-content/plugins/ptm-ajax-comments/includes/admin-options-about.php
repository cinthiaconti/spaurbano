...
<div id="about" class="optionTab">
	<h3>About this plugin</h3>
	<p>PTM AJAX Comments is a complete rewrite of '<a href="http://wordpress.org/extend/plugins/if-ajax-comments-for-wordpress/" target="_blank">iF AJAX Comments For WordPress</a>' from the same <a href="http://www.flowdrops.com/" target="_blank">author</a>.<br />
	The rewrite was necessary because the old version didn't implement WP's best practices for doing ajax calls. This new version has now an improved codebase &amp; better load performance.</p>
