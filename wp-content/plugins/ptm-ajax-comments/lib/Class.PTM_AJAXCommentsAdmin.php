...
class PTM_AJAXCommentsAdmin extends PTM_AJAXComments
{
	...
	{
		add_comments_page( 'PTM AJAX Comments', 'AJAX Comments', 10, 'ptm-ajax-comments', array( $this, '_displayAdminPage' ) );
	}
	...
	{				
        ...
        <div class="wrap">
            ...
            <form id="ptm-admin-options" name="ptm-admin-options" method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
				...
				<?php require_once( PTM_AJAX_COMMENTS_PLUGINPATH.'/includes/admin-options-about.php' ); ?>
