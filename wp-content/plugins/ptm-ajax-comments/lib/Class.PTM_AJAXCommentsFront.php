...
class PTM_AJAXCommentsFront extends PTM_AJAXComments
{
	...
	function wpWP()
	{
		...
		if ( is_single() || is_page() )
		{
			...
			{
				wp_enqueue_script('jquery_md5', PTM_AJAX_COMMENTS_PLUGINURL.'js/jquery.md5.js', array('jquery'), '1.0' );
			}
			wp_enqueue_script('ptm-ajax-comments', PTM_AJAX_COMMENTS_PLUGINURL.'js/ptm-ajax-comments.js', array('jquery', 'jquery-form'), '1.0.0' );
		}
	}
